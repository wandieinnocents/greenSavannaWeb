				...
				<div class="row">
					<div class="col-xl-12">
						<div class="welcome-card rounded pl-5 pt-5 pb-4 mt-3 position-relative mb-5">
							<h4 class="text-warning">GREEN SAVANNAH </h4>
							<p>We are GREEN SAVANNA HOLDINGS LTD with interests in agroforestry, horticulture and echo tourism in Uganda since 2017. 
								Specifically, we are invested in the production of eucalyptus hybrid clones, seedlings of eucalyptus grandis, many 
								indigenous tree species and fruit trees such as Hass Avocado.</p>
